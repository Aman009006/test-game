...
<div class="modal-body">
	...
	<div class="form-body">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					<label class="control-label">Выпадание</label>
					<select class="form-control" tabindex="1" name="type" value="">
						<option value="0" selected>Выпадает</option>
						<option value="1">Не выпадает</option>
					</select>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group text-center">
					...
					<div class="col-md-12">
						<input type="checkbox" id="subscribeNews" name="in_shop" value="1">
					</div>
				</div>
			</div>
		</div>
