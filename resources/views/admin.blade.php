        ...
        <div class="page-wrapper">
            <div class="page-header navbar navbar-fixed-top">
                <div class="page-header-inner ">
                    <div class="page-logo">
                        <a href="/admin">
                            <img src="{{asset('/build/images/logo.png')}}" alt="logo" class="logo-default" width="150px"> </a>
                ...
                <div class="page-sidebar-wrapper">
                    <div class="page-sidebar navbar-collapse collapse">
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item  ">
                                <a href="/admin/delivers" class="nav-link nav-toggle">
                                    <i class="icon-star"></i>
                                    <span class="title">Доставки</span>
                                </a>
                            </li>
							<li class="nav-item  ">
							...
							<li class="heading">
                                <h3 class="uppercase">Промо-коды</h3>
                            </li>
							
                            <li class="nav-item  ">
								<a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="fa fa-cogs" aria-hidden="true"></i>
                                    <span class="title">Управление кодами</span>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start ">
                                        <a href="/admin/promocodes" class="nav-link ">
                                            <i class="icon-note"></i>
                                            <span class="title">Список промо-кодов</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start ">
                                        <a href="/admin/promohistory" class="nav-link ">
                                            <i class="fa fa-history" aria-hidden="true"></i>
                                            <span class="title">История активации</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
							...
							<li class="heading">
                                <h3 class="uppercase">Аукционы</h3>
                            </li>
                            <li class="nav-item  ">
								<a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="fa fa-rocket" aria-hidden="true"></i>
                                    <span class="title">Управление аукционами</span>
                                    <span class="arrow open"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item start ">
                                        <a href="/admin/auction/add" class="nav-link ">
                                    ...
                                    <li class="nav-item start ">
                                        <a href="/admin/auctions" class="nav-link ">
                                            ...
                                            <span class="title">Список аукционов</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2017 &copy;&nbsp; By &nbsp;
                    <a target="_blank" href="http://cheapscripts.ru">CHEAPSCRIPTS.RU</a>&nbsp;&nbsp;
